...
score_button = digitalio.DigitalInOut(
    board.GP3
)  # Initalize score_button and attach it to GP3
ball_count_button = digitalio.DigitalInOut(
    board.GP2
)  # Initalize ball_count_button and attach it to GP2
...
while True:
    ...
    lcd.print("Finn and Jake VS Zombie")
    # Start at the first line, fifth column (numbering from zero).
    ...
    for for 16x2 character lcd with an I2C LCD backpack."""
import time
import board
import busio
import digitalio
